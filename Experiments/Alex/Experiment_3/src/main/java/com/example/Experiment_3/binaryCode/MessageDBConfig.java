...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = {"com.example.Experiment_3.binaryCode"}, transactionManagerRef = "transactionManager")
public class MessageDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder, @Qualifier("datasource") DataSource dataSource) {
        ...
        return builder.dataSource(dataSource).properties(properties).packages("com.example.Experiment_3.binaryCode").persistenceUnit("Message").build();
    }
